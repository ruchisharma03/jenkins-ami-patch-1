...
pipeline {
  ...
  post {
    ...
    success {
      ...
      jiraSendDeploymentInfo environmentId: '1', environmentName: 'test', environmentType: 'development', issueKeys: ['L1'], serviceIds: [''], site: 'raghav-personal.atlassian.net', state: 'pending'
    }
    failure {
