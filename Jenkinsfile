...
pipeline {
  ...
  post {
    ...
    success {
      ...
      jiraSendDeploymentInfo environmentId: '1', environmentName: 'LEARN', environmentType: 'development', issueKeys: ['3'], serviceIds: [''], site: 'raghav-personal.atlassian.net', state: 'pending'
    }
    failure {
